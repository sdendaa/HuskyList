...
import tcss450.uw.edu.mynewapp.CellPhoneListFragment.OnCellPhoneListFragmentInteractionListener;
 ...
 *
 */
public class MyCellPhoneRecyclerViewAdapter extends RecyclerView.Adapter<MyCellPhoneRecyclerViewAdapter.ViewHolder> {
    ...
    private final OnCellPhoneListFragmentInteractionListener mListener;
     ...
     */
    public MyCellPhoneRecyclerViewAdapter(List<ItemContent> items, OnCellPhoneListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
        ...
        holder.mView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (null != mListener) {
                    ...
                    mListener.onCellPhoneListFragmentInteraction(holder.mItem);
                }
            }
        });
    }
