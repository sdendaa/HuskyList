...
import tcss450.uw.edu.mynewapp.VehiclesListFragment.OnVehiclesListFragmentInteractionListener;
import tcss450.uw.edu.mynewapp.model.ItemContent;

import java.util.List;

/**
 * {@link RecyclerView.Adapter} that can display a {@link ItemContent} and makes a call to the
 * specified {@link OnVehiclesListFragmentInteractionListener}.
 *
 */
public class MyVehiclesRecyclerViewAdapter extends RecyclerView.Adapter<MyVehiclesRecyclerViewAdapter.ViewHolder> {
    ...
    private final OnVehiclesListFragmentInteractionListener mListener;
     ...
     */
    public MyVehiclesRecyclerViewAdapter(List<ItemContent> items, OnVehiclesListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
        ...
        holder.mView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (null != mListener) {
                    ...
                    mListener.onVehiclesListFragmentInteraction(holder.mItem);
                }
            }
        });
    }
