...
import tcss450.uw.edu.mynewapp.VideoGameListFragment.OnVideoGameListFragmentInteractionListener;
 ...
 *
 */
public class MyVideoGameRecyclerViewAdapter extends RecyclerView.Adapter<MyVideoGameRecyclerViewAdapter.ViewHolder> {
    ...
    private final OnVideoGameListFragmentInteractionListener mListener;
     ...
     */
    public MyVideoGameRecyclerViewAdapter(List<ItemContent> items, VideoGameListFragment.OnVideoGameListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
        ...
        holder.mView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (null != mListener) {
                    ...
                    mListener.onVideoGameListFragmentInteraction(holder.mItem);
                }
            }
        });
    }
